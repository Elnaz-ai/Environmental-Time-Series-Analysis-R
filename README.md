\# Environmental Time-Series and Trend Analysis Using R
...
This project demonstrates the use of R for analyzing long-term environmental

monitoring data. The analysis focuses on identifying temporal patterns,

seasonal variability, and long-term trends using robust statistical and
...
\- Non-parametric trend estimation (Theil–Sen)

\- Spatial–meteorological interpretation
